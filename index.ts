...
console.log("Task#01");
let Arr = [1, 2, 3, 4, 5];
function take_value(arr:any, index:any, value:any) {
...
//Task#02
console.log("Task#02");
function add_item(arr:any,index:any,value:any){
    arr.splice(index,0,'Sugar 5kg');
    console.log("After adding items\n",arr);
}
function remove_item(arr:any,index:any){
    arr.splice(index,1);
    console.log("After removing items\n",arr);
}
function updating_item(arr:any,index:any,value:any){
